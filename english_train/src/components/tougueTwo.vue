<template>
  <div class="dayVoca">
    <ul class="lineKs">
      <li class="lineKsLi" data-keys="1" v-for="(item, index) in pastOrals" @click="gotoDetail($event, item.studyId)" :key="index">
        <div class="meDiv">
...
export default {
  ...
  created () {
    ...
    $.ajax({
      type: 'get',
      url: _this.httpHl + '/camp/pastOrals',
      data: {
