<template>
  <div class="textCont">
    <div class="bottomClr">
      <div class="headTab">
        <div :class="['headTabLeft', {tabShow: tabShow1}]" @click="tabShowO()">本周写作作业</div>
...
import $ from 'jquery'
import writOne from '@/components/writOne'
import writTwo from '@/components/writTwo'
export default {
  name: 'everyWrit',
  mixins: [gif],
  data () {
  ...
  methods: {
    tabShowO: function () {
      this.tabShow1 = true
      this.tabShow2 = false
      this.currentView = 'writOne'
    },
    tabShowT: function () {
      this.tabShow1 = false
      this.tabShow2 = true
      this.currentView = 'writTwo'
    },
