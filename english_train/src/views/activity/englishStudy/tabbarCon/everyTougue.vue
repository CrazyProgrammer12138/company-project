<template>
  <div class="textCont">
    <div class="bottomClr">
      <div class="headTab">
        <div :class="['headTabLeft', {tabShow: tabShow1}]" @click="tabShowO()">本周口语</div>
...
import $ from 'jquery'
import tougueOne from '@/components/tougueOne'
import tougueTwo from '@/components/tougueTwo'
export default {
  name: 'everyTougue',
  mixins: [gif],
  data () {
  ...
  methods: {
    tabShowO: function () {
      this.tabShow1 = true
      this.tabShow2 = false
      this.currentView = 'tougueOne'
    },
    tabShowT: function () {
      this.tabShow1 = false
      this.tabShow2 = true
      this.currentView = 'tougueTwo'
    },
