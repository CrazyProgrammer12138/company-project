<template>
  <div class="textCont">
    <div class="bottomClr">
      <div class="headTab">
        <div :class="['headTabLeft', {tabShow: tabShow1}]" @click="tabShowO()">今日词汇</div>
...
import $ from 'jquery'
import StudyComOne from '@/components/studyComOne'
import StudyComTwo from '@/components/studyComTwo'
export default {
  name: 'everyDaily',
  mixins: [gif],
  data () {
  ...
  methods: {
    tabShowO: function () {
      this.tabShow1 = true
      this.tabShow2 = false
      this.currentView = 'StudyComOne'
    },
    tabShowT: function () {
      this.tabShow1 = false
      this.tabShow2 = true
      this.currentView = 'StudyComTwo'
    },
